			...
			<?php if ( $available_tickets ) : ?>
              ...
              <th class="tix-column-quantity" width="10%">
                ...
                <td class="tix-column-quantity" style="vertical-align: middle;">
                  <input class="ticket-quantity" type="checkbox" name="tix_tickets_selected[<?php echo $ticket->ID; ?>]" value="1" <?php if( $ticket_key == 370 ){ echo 'checked';} ?>>
                  <label></label>
                  <?php
                  // 通常のキャンセルフォームを置換
          ...
          <tbody>
            ...
            <tr>
              ...
              <label for="tix_refund_request_transfer_true">
                <input id="tix_refund_request_transfer_true" type="radio" name="tix_refund_request_transfer" value="1" > 済
              </label>
              <label for="tix_refund_request_transfer_false">
                <input id="tix_refund_request_transfer_false" type="radio" name="tix_refund_request_transfer" value="0"> 未
              </label>
              </td>
            </tr>
            <tr>
              ...
              <label for="tix_refund_request_transfer_method_true">
                <input id="tix_refund_request_transfer_method_true" type="radio" name="tix_refund_request_transfer_method" value="1" > 当日受付にて現金で返金
              </label>
              <label for="tix_refund_request_transfer_method_false">
                <input id="tix_refund_request_transfer_method_false" type="radio" name="tix_refund_request_transfer_method" value="0"> 振込で返金（振込手数料を除いた金額を返金）
              </label>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tix-right">
                <label for="tix_refund_bank_port_type_true">
                  <input type="radio" id="tix_refund_bank_port_type_true" name="tix_refund_bank_port_type" value="1"> 普通
                </label>
                <label for="tix_refund_bank_port_type_false">
                  <input type="radio" id="tix_refund_bank_port_type_false" name="tix_refund_bank_port_type" value="0"> 当座
                </label>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tix-right"><textarea class="form-control" name="tix_refund_request_reason"><?php echo esc_textarea( $reason ); ?></textarea></td>
            </tr>
	...
	function table( $rows, $classes='widefat' ) {
      ...
      // 追加
        ...
        if ( $reason = get_post_meta( $_GET['post'], 'tix_refund_reason' , true ) && $reason ) { ?>
          <tr>
            <th colspan="2" style="height: 30px;text-align: left;padding-left: 10px;background: #ccc;"> キャンセル </th>
          </tr>
